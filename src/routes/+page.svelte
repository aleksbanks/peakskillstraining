<script>
	...
	import GymSection from '$lib/components/Sections/GymSection.svelte';
	import MissionSection from '$lib/components/Sections/MissionSection.svelte';
...
<main aria-label="main page content" in:fade={{ duration: 300 }}>
	<WelcomeSection />
	<GymSection />
	<MissionSection />
	<FounderSection />
